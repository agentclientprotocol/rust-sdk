...
async fn test_scoped_mcp_server_through_proxy() -> Result<(), agent_client_protocol::Error> {
    ...
    expect_test::expect![[r#"
        "OK: CallToolResult { result_type: Some(ResultType(\"complete\")), content: [Text(TextContent { text: \"2\", meta: None, annotations: None })], structured_content: None, is_error: Some(false), meta: None }"
