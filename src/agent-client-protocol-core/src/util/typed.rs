...
/// # async fn example(message: Dispatch) -> Result<(), agent_client_protocol_core::Error> {
/// MatchDispatch::new(message)
///     .if_request(|req: InitializeRequest, responder: agent_client_protocol_core::Responder<InitializeResponse>| async move {
...
///                 responder.respond_with_error(agent_client_protocol_core::util::internal_error("unknown method"))
///             }
...
/// ```
/// # use agent_client_protocol_core::Dispatch;
/// # use agent_client_protocol_core::schema::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse, AgentCapabilities, StopReason};
/// # use agent_client_protocol_core::util::MatchDispatchFrom;
/// # async fn example(message: Dispatch, cx: &agent_client_protocol_core::ConnectionTo<agent_client_protocol_core::Client>) -> Result<(), agent_client_protocol_core::Error> {
...
///     })
///     .await
///     .if_request(|_req: PromptRequest, responder: agent_client_protocol_core::Responder<PromptResponse>| async move {
///         // Handle prompts
...
///         match message {
///             Dispatch::Request(_, responder) => responder.respond_with_error(agent_client_protocol_core::util::internal_error("unknown method")),
///             Dispatch::Notification(_) | Dispatch::Response(_, _) => Ok(()),
///         }
///     })
///     .await
...
///
/// ```
/// # use agent_client_protocol_core::{UntypedMessage, ConnectionTo, Agent};
/// # use agent_client_protocol_core::schema::SessionNotification;
/// # use agent_client_protocol_core::util::TypeNotification;
/// # async fn example(message: UntypedMessage, cx: &ConnectionTo<Agent>) -> Result<(), agent_client_protocol_core::Error> {
