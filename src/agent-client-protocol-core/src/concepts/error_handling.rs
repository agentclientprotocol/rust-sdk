//! Error handling patterns in agent-client-protocol-core.
//!
//! This chapter explains how errors work in agent-client-protocol-core callbacks and the difference
//! between *protocol errors* (sent to the peer) and *connection errors* (which
//! shut down the connection).
//!
//! # Callback Return Types
//!
//! Almost all agent-client-protocol-core callbacks return `Result<_, crate::Error>`. What happens
...
//! cx.send_error_notification(agent_client_protocol_core::Error::internal_error()
...
//! you need to convert them to `agent_client_protocol_core::Error`. The
//! [`Error::into_internal_error`][crate::Error::into_internal_error] method
//! provides a convenient way to do this:
//!
//! ```
//! use agent_client_protocol_core::Error;
//!
//! # fn example() -> Result<(), agent_client_protocol_core::Error> {
//! # let data = "hello";
//! # let path = "/tmp/test.txt";
//! // Convert any error type to agent_client_protocol_core::Error
...
//!
//! ```
//! let error = agent_client_protocol_core::Error::invalid_params()
