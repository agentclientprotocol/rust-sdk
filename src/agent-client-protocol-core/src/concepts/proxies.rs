...
//!
//! ```
//! # use agent_client_protocol_core::{Proxy, Conductor, ConnectTo};
//! # async fn example(transport: impl ConnectTo<Proxy>) -> Result<(), agent_client_protocol_core::Error> {
//! Proxy.builder()
...
//!
//! ```
//! # use agent_client_protocol_core::{Proxy, Client, Agent, Conductor, ConnectTo};
...
//!
//! ```
//! # use agent_client_protocol_core::{Proxy, Client, Conductor, ConnectTo};
