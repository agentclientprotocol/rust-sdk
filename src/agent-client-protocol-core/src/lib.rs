...
//! # agent-client-protocol-core -- the Symposium Agent Client Protocol (ACP) SDK
//!
//! **agent-client-protocol-core** is a Rust SDK for building [Agent-Client Protocol (ACP)][acp] applications.
...
//!
//! ## What can you build with agent-client-protocol-core?
//!
...
//! ## Core Concepts
//!
//! The [`concepts`] module provides detailed explanations of how agent-client-protocol-core works,
...
pub mod component;
/// Core concepts for understanding and using agent-client-protocol-core
pub mod concepts;
...
///
/// Users of the `agent-client-protocol-core` crate can use these types without adding a direct dependency
/// on `jsonrpcmsg`.
pub mod jsonrpcmsg {
