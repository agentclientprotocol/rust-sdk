...
///
/// ```rust,ignore
/// use agent_client_protocol_core::mcp_server::{McpTool, McpContext};
/// use schemars::JsonSchema;
...
/// struct EchoTool;
///
/// impl<R: agent_client_protocol_core::role::Role> McpTool<R> for EchoTool {
...
///     ) -> Result<EchoOutput, agent_client_protocol_core::Error> {
///         Ok(EchoOutput {
