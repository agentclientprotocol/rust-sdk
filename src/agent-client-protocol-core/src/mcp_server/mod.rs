...
//!
//! ```rust,ignore
//! use agent_client_protocol_core::mcp_server::{McpServer, McpTool};
//!
...
//!
//! ```rust,ignore
//! use agent_client_protocol_core::mcp_server::{McpServer, McpServerConnect, McpContext};
//! use agent_client_protocol_core::{DynComponent, JrLink};
//!
