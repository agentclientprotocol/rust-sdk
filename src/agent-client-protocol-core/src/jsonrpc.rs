...
///
/// ```
/// # use agent_client_protocol_core::{Agent, Client, ConnectTo};
...
/// # async fn example(transport: impl ConnectTo<Agent>) -> Result<(), agent_client_protocol_core::Error> {
/// Agent.builder()
...
/// # use agent_client_protocol_core::schema::{InitializeRequest, InitializeResponse, SessionNotification};
...
/// ```no_run
/// # use agent_client_protocol_test::*;
/// # use agent_client_protocol_core::{JsonRpcRequest, JsonRpcMessage, UntypedMessage};
/// # use agent_client_protocol_core::schema::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse};
/// # async fn example() -> Result<(), agent_client_protocol_core::Error> {
/// # let connection = mock_connection();
...
/// #     fn to_untyped_message(&self) -> Result<UntypedMessage, agent_client_protocol_core::Error> { todo!() }
/// #     fn parse_message(_method: &str, _params: &impl serde::Serialize) -> Result<Self, agent_client_protocol_core::Error> { Err(agent_client_protocol_core::Error::method_not_found()) }
/// # }
...
/// ```no_run
/// # use agent_client_protocol_test::*;
/// # use agent_client_protocol_core::{Dispatch, UntypedMessage};
/// # use agent_client_protocol_core::schema::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse};
/// # async fn example() -> Result<(), agent_client_protocol_core::Error> {
/// # let connection = mock_connection();
/// connection
...
///         msg.respond_with_error(agent_client_protocol_core::util::internal_error("unknown method"), cx)
///     }, agent_client_protocol_core::on_receive_dispatch!())
/// # .connect_to(agent_client_protocol_test::MockTransport).await?;
/// # Ok(())
/// # }
...
///
/// ```no_run
/// # use agent_client_protocol_core::UntypedRole;
/// # use agent_client_protocol_core::{Builder};
/// # use agent_client_protocol_core::ByteStreams;
/// # use agent_client_protocol_core::schema::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse, SessionNotification};
...
> Builder<Host, Handler, Runner>
{
    ...
    /// # use agent_client_protocol_core::UntypedRole;
    /// # use agent_client_protocol_core::{Builder};
    /// # use agent_client_protocol_core::schema::{PromptRequest, PromptResponse, SessionNotification};
    /// # fn example<R: agent_client_protocol_core::Role>(connection: Builder<R, impl agent_client_protocol_core::HandleMessageAs<R>>) {
...
impl<Counterpart: Role> ConnectionTo<Counterpart> {
    ...
    /// ```
    /// # use agent_client_protocol_core::UntypedRole;
    /// # use agent_client_protocol_core::{Builder, ConnectionTo};
    /// # use agent_client_protocol_test::*;
    /// # async fn example(cx: ConnectionTo<UntypedRole>) -> Result<(), agent_client_protocol_core::Error> {
    ...
    /// ```compile_fail
    /// # use agent_client_protocol_test::*;
    /// # async fn example(cx: agent_client_protocol_core::ConnectionTo<agent_client_protocol_core::UntypedRole>) -> Result<(), agent_client_protocol_core::Error> {
    ...
    /// ```no_run
    /// # use agent_client_protocol_test::*;
    /// # async fn example(cx: agent_client_protocol_core::ConnectionTo<agent_client_protocol_core::Agent>) -> Result<(), agent_client_protocol_core::Error> {
    /// cx.send_notification(StatusUpdate {
...
///
/// ```ignore
/// use agent_client_protocol_core::JsonRpcResponse;
...
///
/// ```ignore
/// use agent_client_protocol_core::JsonRpcNotification;
/// use serde::{Serialize, Deserialize};
///
...
///
/// ```ignore
/// use agent_client_protocol_core::{JsonRpcRequest, JsonRpcResponse};
/// use serde::{Serialize, Deserialize};
///
...
impl<Req: JsonRpcRequest, Notif: JsonRpcMessage> Dispatch<Req, Notif> {
    ...
    /// Erase typed payloads to a JSON/untyped `Dispatch`.
    ///
    /// Requests and notifications are converted to [`UntypedMessage`].
    /// Responses are converted back to JSON values using the original request method.
    pub fn erase_to_json(self) -> Result<Dispatch, crate::Error> {
        match self {
            ...
            Dispatch::Response(result, router) => {
                ...
                Ok(Dispatch::Response(untyped_result, router.erase_to_json()))
            }
        }
    }
...
impl<T: JsonRpcResponse> SentRequest<T> {
    ...
    ///             } else {
    ///                 responder.respond_with_error(agent_client_protocol_core::util::internal_error("validation failed"))
    ///             }
    ///         })?;
    ///
    ///     Ok(())
...
/// agent_client_protocol_core::UntypedRole.builder()
///     .name("my-client")
...
/// ```no_run
/// # use agent_client_protocol_core::UntypedRole;
/// # use agent_client_protocol_core::{Channel, Builder};
/// # async fn example() -> Result<(), agent_client_protocol_core::Error> {
