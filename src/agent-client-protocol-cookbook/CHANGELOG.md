...
## [0.11.2](https://github.com/agentclientprotocol/rust-sdk/compare/agent-client-protocol-cookbook-v0.11.1...agent-client-protocol-cookbook-v0.11.2) - 2026-04-27

### Other

- updated the following local packages: agent-client-protocol, agent-client-protocol-conductor, agent-client-protocol-tokio, agent-client-protocol-rmcp
